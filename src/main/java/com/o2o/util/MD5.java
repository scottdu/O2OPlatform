...
public class MD5 {
    ...
    public static String md5(String input)
    {
    	...
    	{
    		MD5 md5 = new MD5();
    		ret = md5.getMD5ofString(input.getBytes("UTF-8"), input.getBytes("UTF-8").length);
    		ret = ret.toUpperCase();
    	}
    	catch(Exception e)
    	{
    ...
    public static String Str2MD5(String data) {
    	MD5 md5 = new MD5();
    	return md5.getMD5ofString(data.getBytes(), data.getBytes().length);
    }
